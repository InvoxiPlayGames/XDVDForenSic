...
namespace XDVDForenSic
{
    internal static class StreamExtensions
    {
        ...
        /// <summary>
        /// Read a length-prefixed string of the specified encoding type from the file.
        /// The length is a 8-bit integer.
        /// </summary>
        /// <param name="s"></param>
        /// <param name="e">The encoding to use to decode the string.</param>
        /// <returns></returns>
        public static string ReadByteLengthPrefixedString(this Stream s, Encoding e)
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static string ReadByteLengthUTF8(this Stream s)
        {
            return s.ReadLengthPrefixedString(Encoding.UTF8);
        }
